...
HD_PWD='C:/Github_Repo/Logic_Design_final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blackjack.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blackjack.tcl -notrace
