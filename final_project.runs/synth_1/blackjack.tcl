...
namespace eval ::optrace {
  variable script "C:/Github_Repo/Logic_Design_final_project/final_project.runs/synth_1/blackjack.tcl"
...
read_verilog -library xil_defaultlib C:/Github_Repo/Logic_Design_final_project/final_project.srcs/sources_1/new/black_jack.v
...
synth_design -top blackjack -part xc7z020clg400-1
...
write_checkpoint -force -noxdef blackjack.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file blackjack_utilization_synth.rpt -pb blackjack_utilization_synth.pb"
