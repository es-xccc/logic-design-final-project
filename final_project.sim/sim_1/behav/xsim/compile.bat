...
REM
REM Generated by Vivado on Wed Jun 14 20:49:32 +0800 2023
...
echo "xvlog --incr --relax -prj led_shift_vlog.prj"
call xvlog  --incr --relax -prj led_shift_vlog.prj -log xvlog.log
